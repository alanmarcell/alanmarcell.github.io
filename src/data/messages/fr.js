module.exports = {
  'title': `Alan Marcell Développement d'applications Web`,
  'header.title': 'Alan Marcell',
  'header.subTitle': `Développement d'applications Web`,
  ...
  'resume.technologies.level.proficient': 'Débutant',
  'resume.technologies.level.novice': 'Compétent',

  'resume.technologies.yearsMsg': `{nYears, number} {nYears, plural, one {an} other {ans} }`,

  'resume.project.link': 'Lien',
  'resume.project.years': `{nYears, plural, one {An} other {Ans} }`,
